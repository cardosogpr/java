...
public class Product extends Entity {
	...
	public float getPvp() {
        float precoComDesconto = (float) (this.pvp - this.discount);

        float valorIVA = (float) (precoComDesconto * this.iva / 100);

        float pvpCalculado = precoComDesconto + valorIVA;
